...
object Protocol {
  ...
  // Lease times
  val INJECTOR_LEASE_TIME: Long = getOrDefault("INJECTOR_LEASE_TIME", 1 * HOUR)
  ...
  val ANALYSER_CHECK_GRAPHS_TIME: Long = getOrDefault("ANALYSER_CHECK_GRAPHS_TIME", 20 * 1000)
  ...
  val NODE_INCREMENT_SLEEP_TIME: Long = getOrDefault("NODE_INCREMENT_SLEEP_TIME", 250)
